...
import { type UserPayload } from "@/app/(backend)/libs/auth";
...
export default function MainLayout({
  ...
  return (
    <div className="relative flex flex-col max-w-[100vw] overflow-x-clip">
      {renderNavbar()}

      <main
        className={`flex-grow overflow-x-clip ${!shouldHideLayout ? "pt-[8vh]" : ""}`}
      >
        {children}
      </main>
