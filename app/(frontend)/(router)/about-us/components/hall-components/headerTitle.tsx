    ...
    <div className="relative inline-block md:ml-16">
      ...
      <div className="relative z-10 flex flex-row leading-none gap-2 md:gap-4 p-2">
        <div className="flex flex-col items-end md:gap-2">
          <span className="xl:text-8xl lg:text-7xl text-6xl font-extrabold text-[#2C305F]">
            Hall
          </span>
          <span className="xl:text-5xl lg:text-4xl text-3xl font-bold text-[#5E5E92]">
            {year}
          </span>
        </div>

        <div className="flex flex-col items-start md:gap-1">
          <span className="xl:text-5xl lg:text-4xl text-3xl font-semibold text-[#2C305F] ">
            OF
          </span>
