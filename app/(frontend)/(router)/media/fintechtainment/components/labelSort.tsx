...
export default function LabelSort({
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 max-md:px-6">
      ...
      <div className="relative w-full md:w-64">
        ...
        <select
          ...
          className="pl-10 pr-8 py-2 rounded-xl bg-[#f6f4ff] text-[#2A2A57] font-medium shadow-md w-full cursor-pointer appearance-none focus:outline-none focus:ring-2 focus:ring-[#DBB968]"
        >
